                ...
                <div className='flex flex-col lg:flex-row justify-center lg:gap-16 mb-20'>
                    <div className='flex flex-col gap-4 mt-5 lg:m-0'>
                        <div className='flex flex-col items-center lg:items-start justify-center lg:justify-start'>
                            <BrandLink href='/' body='WAKA DAIKO' extraClasses='text-black dark:text-white' />
                        </div>
                        <div className='flex flex-col gap-4 text-center lg:text-start'>
                            <div className='text-[10px]'>&copy; 2003-2024 Waka Daiko&trade;. All rights reserved.</div>
                            <div className='flex justify-center lg:justify-start gap-2'>
                                <Link type='footer' body='Legal' href='/disclaimers/legal' />
                                |
                                <Link type='footer' body='Privacy Policy' href='/disclaimers/privacy' />
                                |
                                <Link type='footer' body='Cookies' href='/disclaimers/cookies' />
                            </div>
                        </div>
                    </div>
                    <div className={cssRowParent}>
                        ...
                        <div className={`${cssRowChild} flex-col`}>
                            <Link type='footer' href='/news/press' body='Press' />
                            <Link type='footer' href='/news/events' body='Events' />
                            <Link type='footer' href='/news/tryouts' body='Tryouts' />
                            <Link type='footer' href='/news/website' body='Website' />
                        </div>
                    </div>
                    <div className={cssRowParent}>
                        <div className={cssHeading}>
                        ...
                        <div className={`${cssRowChild} flex-col`}>
                            <Link type='footer' href='/learning/videos' body='Videos' />
                            <Link type='footer' href='/learning/text' body='Text' />
                        </div>
                    </div>
                    <div className={`${cssRowParent} mt-10 lg:m-0`}>
                        ...
                        <div className={`${cssRowChild} flex-col`}>
                            <Link type='footer' href='/about/team' body='Team' />
                            <Link type='footer' href='/about/culture' body='Culture' />
                            <Link type='footer' href='/about/community' body='Community' />
                        </div>
                    </div>
                    <div className={`${cssRowParent} mt-10 lg:m-0`}>
                        <div className={cssHeading}>
